...
cred = credentials.Certificate("Matching-Scripts/blood-bridge-firebase-adminsdk-qmrwr-ce96587f3a.json")
...
YOUR_API_KEY = "AIzaSyCMqnbpxaebJKRUj27gEOwJmuu2EUQrl60"
